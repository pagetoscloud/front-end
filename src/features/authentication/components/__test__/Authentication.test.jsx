...
// Mock images
vi.mock('../../../../assets/images/jumbotron-hero.png', () => ({
  default: 'jumbotron-hero.png'
}))
vi.mock('../../../../assets/images/google-logo.png', () => ({
  default: 'google-logo.png'
}))
vi.mock('../../../../assets/images/Pixel-style-logo.png', () => ({
  default: 'Pixel-style-logo.png'
}))
...
vi.mock('../styles/Global.styled', async () => {
  const actual = await vi.importActual('../styles/Global.styled')
  return {
    ...actual,
    ForgotPasswordContainer: ({ children }) => (
      <div data-testid="forgot-password-container">{children}</div>
    ),
    ForgotPasswordWrapper: ({ children }) => (
      <div data-testid="forgot-password-wrapper">{children}</div>
    ),
    ForgotPasswordForm: ({ children }) => (
      <form data-testid="forgot-password-form">{children}</form>
    ),
...
describe('Auth Components', () => {
  ...
  describe('EmailVerification', () => {
    it('renders correctly', () => {
      ...
      expect(
        screen.getByText(/Please enter the 4 digit code/i)
      ).toBeInTheDocument()
  ...
  describe('ForgotPassword', () => {
    it('renders correctly', () => {
      ...
      expect(
        screen.getByText(/Enter your email to send verification code/i)
      ).toBeInTheDocument()
  ...
  describe('LoginForm', () => {
    it('renders correctly', () => {
      renderWithRouter(
        <LoginForm authenticationProcess={vi.fn()} status="Login" />
      )
    ...
    it('calls authenticationProcess on login', async () => {
      const authProcessMock = vi.fn()
      renderWithRouter(
        <LoginForm authenticationProcess={authProcessMock} status="" />
      )
      ...
      await waitFor(() => {
        expect(authProcessMock).toHaveBeenCalled()
        expect(authProcessMock).toHaveBeenCalledWith({
  ...
  describe('ResetPassword', () => {
    it('renders correctly', () => {
      ...
      expect(
        screen.getByPlaceholderText('Enter your new passord')
      ).toBeInTheDocument()
      expect(screen.getByText('Confirm Password')).toBeInTheDocument()
      expect(
        screen.getByRole('button', { name: /Verify and Proceed/i })
      ).toBeInTheDocument()
    })
  })
