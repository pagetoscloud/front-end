...
export default function NavigationButton({handleComponentsMode, handleEditMode, componentsMode}){
    return (
        <NavigationContainer>
            {
                !componentsMode ?
            ...
            <MenuNav>
                <img  onClick={() => handleComponentsMode('Type')} src={blurIcon} alt="share icon" />
                <p>Type</p>
            </MenuNav>
            <MenuNav>
