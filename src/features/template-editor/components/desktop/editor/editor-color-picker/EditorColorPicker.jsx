...
import { ColorListGradientWrapper, ColorListItems, ColorListItemsDisplay, ColorListWrapper, ColorPickerHeader, GradientType, GradientTypeWrapper, SelectColorType } from "./EditorColorPicker.styled";
            ...
            <ColorPickerHeader>
                {
                    ...
                    <LabelText>{mode === 'border'? 'Border' : 'Text'} Color</LabelText>
                }
