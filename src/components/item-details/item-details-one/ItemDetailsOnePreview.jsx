...
} from "./ItemDetailsOnePreview.styled";
import arrowDown from '../../../assets/images/arrow-down.png';

export default function ItemDetailOnePreview({page, styleData, handleChangePage, currentItems}){
    // console.log(styleData.product.style);
    return (
        <>
            {
                page === 'page two' ?
