...
import { ItemDetailsBox, ItemDetailsBoxHover, ItemDetailsButton, ItemDetailsImage, ItemDetailslBoxBackground, ItemDetailsText, ItemDetailsWrapper, ItemsDetailsInput } from "./ItemDetailsOneEdit.styled";
        ...
        <>
            {
                ...
                >
                    ...
                    <ItemDetailsBox>
                        ...
                        />
                        <ItemDetailsImage onClick={() => handleEditMode({mode: 'Image', type: 'image', component: 'itemDetails', image: contentData.banner.image})}>
                            <img 
