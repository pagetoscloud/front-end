import { 
    ...
    ItemDetailsCircle, ItemDetailsImage, 
    ItemDetailsText, ItemDetailsWrapper, 
    ItemsDescription, ItemsDetailsBackground, // ItemsDetailsInput, 
    ItemsPrice, ItemsTitle
} from './ItemDetailsTwoPreview.styled';
// import closeIcon from '../../../../assets/images/close-icon.png';
// import addIcon from '../../../../assets/images/Plus-Math.png';

export default function ItemDetailsTwoPreview({page, styleData, contentData, handleChangePage, currentItems}){
                ...
                <ItemDetailsWrapper>
                    <ItemDetailsBox>
                        ...
                        <ItemDetailsText>
                            ...
                            <ItemsPrice style={styleData.itemDetails.price}>{currentItems.price}</ItemsPrice>
                        </ItemDetailsText>
                        <ItemDetailsButton 
                            style={styleData.itemDetails.style.button}
                            onClick={() => {
