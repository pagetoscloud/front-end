...
import { 
    ...
    Image,
    ImageWrapper,
    ItemDetailsBox, ItemDetailsBoxHover, ItemDetailsButton, ItemDetailsCircle, ItemDetailsImage, 
    ItemDetailslBoxBackground, 
    ItemDetailsText, ItemDetailsWrapper, 
    ItemsDetailsBackground, 
    ItemsDetailsInput 
} from "./ItemDetailsFourEdit.styled";




export default function ItemDetailsFourEdit({page, styleData, contentData, handleEditMode}){
                ...
                <ItemDetailsWrapper>
                    ...
                    <ItemDetailsBox>
                        ...
                        <ImageWrapper>
                            ...
                            >
                                <BoxEditWrapper 
                                    style={activeFive ? {boxShadow: '0px 0px 0px 1px blue inset'}: {}}
                                />
                                <Image 
