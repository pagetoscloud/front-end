...
import ItemsFourEdit from "./ItemFourEdit";
import ItemsFourPreview from "./ItemFourPreview";
export default function ItemFour({styleData, data, items, handleEditMode, mode, handleChangePage, handleChangeCurrentItems, onEdit}){
