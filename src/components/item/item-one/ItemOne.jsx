...
import ItemsOneEdit from "./ItemOneEdit";
import ItemsOnePreview from "./ItemOnePreview";
import { deleteProduct, editProduct } from "../../../features/template-editor/templateProductSlice";
export default function ItemOne({styleData, data, items, handleEditMode, mode, handleChangePage, handleChangeCurrentItems, onEdit}){
