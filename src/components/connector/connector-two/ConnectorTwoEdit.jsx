        ...
        <>
        {
            ...
            <ConnectorOneEditContainer>
                <ConnectorOneBackgroundHover
                    ref={refOne} 
                    style={activeOne ? {border: "1px solid blue"} : {}}
                    onClick={() => {
                        setActiveOne(true);
                        handleEditMode({mode: 'Background', type: 'background', component: 'connector'})}
                    }
                />
                <ConnectorOneEditBox>
                    ...
                    <ConnectorOneBackground 
                        style={{
                                borderRadius: `${styleData.connector.style.background.borderRadius}px ${styleData.connector.style.background.borderRadius}px 0 0`,
                                background: styleData.connector.style.background.background
                        }}
                    />
